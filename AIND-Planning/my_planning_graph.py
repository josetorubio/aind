...
class PlanningGraph():
    ...
    def add_action_level(self, level):
        ...
        for action in self.all_actions:
            ...
            if node_action.prenodes.issubset(self.s_levels[level]):
                action_nodes.append(node_action)
    ...
    def add_literal_level(self, level):
        ...
        # make sure state_nodes is unique by usign set()
        state_nodes = set()
        for node_action in self.a_levels[level - 1]:
            ...
            for node_state in node_action.effnodes:
                state_nodes.add(node_state)
                node_action.children.add(node_state)
                node_state.parents.add(node_action)
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        for precond_action1 in node_a1.parents:
            for precond_action2 in node_a2.parents:
                if precond_action2.is_mutex(precond_action1):
                    return True
